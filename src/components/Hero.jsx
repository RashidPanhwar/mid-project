  ...
  return (
    ...
    <div className='flex flex-col md:grid md:grid-cols-2 text-center items-center text-white'>
        ...
        <div className=' md:flex md:flex-col px-8 py-10 items-start md:px-28'>
            <h3 className='mt-10 text-2xl md:text-4xl font-semibold leading-10'>Create Account</h3>
            <p className='text-sm md:text-lg leading-6 font-normal text-start py-4'>
            ...
            {loginBox.map((items, i) => {
                ...
                <span className='text-black'> {items.icon} </span>
